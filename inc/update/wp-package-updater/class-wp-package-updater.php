	...
	class WP_Package_Updater {
		...
		public function add_admin_scripts( $hook ) {
			...
			if ( $condition ) {
				...
				$ver_js = filemtime( $this->package_path . 'inc/update/wp-package-updater/js/main' . $js_ext );
				$params = array(
					'action_prefix' => 'wppu_' . $this->package_id,
					'ajax_url'      => admin_url( 'admin-ajax.php' ),
				);

				wp_enqueue_script( 'wp-package-updater-script', $this->package_url . '/inc/update/wp-package-updater/js/main' . $js_ext, array( 'jquery' ), $ver_js, true );
		...
		public function print_license_form_theme_page() {
			...
			require_once $this->package_path . 'inc/update/wp-package-updater/templates/theme-page-license.php';
		...
		public function print_license_under_plugin( $plugin_file = null, $plugin_data = null, $status = null ) {
			...
			require_once $this->package_path . 'inc/update/wp-package-updater/templates/plugin-page-license-row.php';
		...
		protected function get_license_form() {
			...
			require_once $this->package_path . 'inc/update/wp-package-updater/templates/license-form.php';
